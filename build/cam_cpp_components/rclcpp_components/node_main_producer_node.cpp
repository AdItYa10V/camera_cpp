...
#define NODE_MAIN_LOGGER_NAME "producer_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmulti_stage_components.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<multi_stage::Producer>";
